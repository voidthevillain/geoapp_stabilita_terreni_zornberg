...
export const createDocument = () => {
  return (() => {
    ...
    if (typeof fs_tot === 'undefined' || typeof t_amm === 'undefined' || typeof tp === 'undefined' || typeof n === 'undefined' || typeof s === 'undefined' || typeof fsr === 'undefined') { // t_amm, tp, n, s, fsr
      ...
      const p3 = new Paragraph()
      const p3_1 = new TextRun('').bold().size(24)
      p3.addRun(p3_1)
      doc.addParagraph(p3)
      ...
      const p29_1 = new TextRun('Calcolo stabilità').bold().size(24).break()
      p29.addRun(p29_1)
      ...
      const p31_1 = new TextRun('Azione tangenziale in direzione dello scorrimento').size(24)
      const p31_2 = new TextRun('S').size(24).tab().tab().tab()
      const p31_3 = new TextRun(s.toFixed(2)).bold().size(24).tab().tab()
      const p31_4 = new TextRun('kN').size(24).tab()
      p31.addRun(p31_1)
      p31.addRun(p31_2)
      p31.addRun(p31_3)
      p31.addRun(p31_4)
      ...
      const p32_1 = new TextRun('Fattore di sicurezza scorrimento').size(24)
